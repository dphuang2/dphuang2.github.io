...
found something more simple yet feature-complete as markdown for authoring
...
every aspect of your resume - from fonts and colors to layout and spacing -
giving you complete control over the visual presentation while keeping the
...
HTML to PDF. I chose puppeteer over alternatives like wkhtmltopdf because
wkhtmltopdf wasn't properly respecting flex CSS properties.
