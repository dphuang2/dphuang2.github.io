...
coupling between your app and tool implementations. With MCP, you write your
client code once, and you modularly add new tools as you need them. Here is the
